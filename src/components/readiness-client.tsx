...
export function ReadinessClient({ isSignedIn }: { isSignedIn: boolean }) {
  ...
  return (
    <AppShell title="Readiness">
      ...
      {!isSignedIn && (
        <Card className="mb-8 border-l-4 border-l-amber-400 dark:border-l-amber-600">
          <CardHeader>
            <CardTitle className="text-xl">{t("Want to save your progress?")}</CardTitle>
            <CardDescription>
              {t("Sign in to save your checklist and access your dashboard, learning paths, and Pro content.")}
            </CardDescription>
          </CardHeader>
