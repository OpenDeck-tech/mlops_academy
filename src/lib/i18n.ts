...
const zhTranslations: Record<string, string> = {
  ...
  "I have helped set up greenfield MLOps foundations to enable AI within different teams.": "我曾帮助搭建从零开始的 MLOps 基础，为不同团队落地 AI 能力。",
  "The objective of A.I Engineering Academy is to transfer my knowledge and experience to those who plan on entering the MLOps and A.I Engineering space, providing them the technical and soft skills to become top talent.": "A.I 工程学院的目标，是将我的知识与经验传递给计划进入 MLOps 与 A.I 工程领域的人，帮助他们掌握成为顶尖人才所需的技术与软技能。",
  "Curated, no-fluff curriculum from real-world experience. Tools change, fundamentals don\u2019t.": "来自实战的精选课程，去芜存菁。工具在变，基础不变。",
